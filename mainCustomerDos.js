...
const client = customers[1]
const card = display[1]
...
function ingresarEvent(){
    window.location = "customerDosIngresar.html"
}
buttonMiddle.onclick = ingresarEvent

function retirarEvent(){
    window.location = "customerDosRetirar.html"
}
